           ...
           "discussion","tmus","diffrent.","layout","area.","thanks","thankyou","hello","bye","rise","fell","fall","psqft.","http://","km","miles"};
			...
			try
			{
				...
				String fip1="";
					...
					FileOutputStream out = new FileOutputStream("E:/MANU/Programs/pbl/src/twitter_cikm_2010/training_set_tweets_stop.txt");

					BufferedReader br = new BufferedReader(new FileReader("E:/MANU/Programs/pbl/src/twitter_cikm_2010/training_set_tweets.txt"));
